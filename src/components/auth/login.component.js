...
import { COMMON_FIELDS, REGISTRATION_FIELDS, LOGIN_FIELDS, LOGIN_MESSAGE, ERROR_IN_LOGIN } from '../../elements/MessageBundle';
            ...
            <form onSubmit={this.onSubmit}>
              <div>
                ...
                <div className="buttons">
                  ...
                  <Link to="/registration">{REGISTRATION_FIELDS.REGISTER}</Link>
                </div>
              </div>
            </form>
